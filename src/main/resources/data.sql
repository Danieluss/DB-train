...
INSERT INTO ticket(uuid, price, discount_id, user_id) VALUES ('de644b9b-7744-4dc4-9501-bb0ef0386952', 35, 1, 1) ON CONFLICT DO NOTHING;
INSERT INTO ticket(uuid, price, user_id) VALUES ('643dafc5-6d35-464c-badd-41d1640e8338', 15.0, 1) ON CONFLICT DO NOTHING;
...
INSERT INTO path_ticket(uuid, station1_id, connection_id, station2_id, date) VALUES ('643dafc5-6d35-464c-badd-41d1640e8338', 1, 1, 2, TIMESTAMP '2020-01-27') ON CONFLICT DO NOTHING;
